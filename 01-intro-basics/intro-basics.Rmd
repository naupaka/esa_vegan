...
* We will use one of vegan's built-in datasets for species `BCI` and environmental variables the same paper, which we will load directly
...
setwd("~/git/esa_vegan/01-intro-basics/data/")
data(BCI.env)
write.csv(BCI.env, "BCI.env.csv")
BCI.env <- read.csv("BCI.env.csv", header = TRUE, row.names = 1)
```
